...
<div class="main-container">
    <div class="container__page-title">
        <h2 class="page__title">Todos los usuarios</h2>
    ...
    <table class="container__table">
        <thead class="container__table-head">
            <tr class="container__table-row row-head">
                ...
                <th class="container__table-celd ">Nombre de usuario</th>
                <th class="container__table-celd ">Nombre</th>
                <th class="container__table-celd ">Apellido</th>
        ...
        <tbody class="container__table-body" id="table_body">
            <?php
            foreach ($rowUsers as $key => $user) { ?> <tr class="container__table-row row-normal" id="row__user-<?php echo $user['id'] ?>">
                    <td class="container__table-celd celd-id"><?php echo $user['id'] ?></td>
                    <td class="container__table-celd celd-username"><?php echo $user['username'] ?></td>
                    <td class="container__table-celd celd-name"><?php echo ($user['nombre'] != null) ? $user['nombre'] : "-" ?></td>
                    <td class="container__table-celd celd-surname"><?php echo ($user['apellido'] != null) ? $user['apellido'] : "-" ?></td>
                    <td class="container__table-celd celd-options">
                        <button type="button" class="btn-update btn__update" id="update-<?php echo $user['id'] ?>" title="Editar">
                        ...
                        <button type="button" class="btn-delete btn__delete" id="delete__user-<?php echo $user['id'] ?>" title="Eliminar">
...
<div class="modal" id="modal__create">
    <div class="modal-content">
        ...
        <div class="container__info-user" id="create-info-user">
        ...
        <div class="modal-input-group">
            ...
            <input type="text" id="create-username" class="modal-input">
            <p class="errormessage__form"></p>
        </div>
        <div class="modal-input-group">
            <label>Contaseña</label>
            <input type="password" id="create-password" class="modal-input">
            <p class="errormessage__form"></p>
        </div>
...
<div class="modal" id="modal__update">
    <div class="modal-content">
        ...
        <div class="container__info-user" id="update-info-user">
            <div class="modal-inputs-double">
                <div class="modal-input-group">
                    <label>Nombre</label>
        ...
        <div class="modal-input-group">
            <label>Nombre de usuario</label>
            <input type="text" id="update-username" class="modal-input">
            <p class="errormessage__form"></p>
        </div>
        <div class="modal-input-group">
            <label>Contaseña actual</label>
            <input type="password" id="update-old_password" class="modal-input">
            <p class="errormessage__form"></p>
        </div>
        <div class="modal-input-group">
            <label>Confirmar/Nueva contaseña</label>
            <input type="password" id="update-new_password" class="modal-input">
            <p class="errormessage__form"></p>
        </div>
        <div class="modal-btns">
